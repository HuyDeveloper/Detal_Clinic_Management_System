...
export default function ViewDentist() {
  ...
  const deleteMedicine = (id) => {
    axios
      .delete(`http://localhost:3000/user/get-all`, { params: { name: id } })
      .then((response) => {
